...
helps['aks create'] = f"""
    ...
    examples:
        ...
        - name: Create a kubernetes cluster with custom configuration
          text: az aks create -g MyResourceGroup -n MyManagedCluster --custom-configuration /path/to/custom-config.json
